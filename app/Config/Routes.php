...
$routes->post('penjualan/edit/(:any)', 'PenjualanController::edit/$1'); 
$routes->get('penjualan/delete/(:any)', 'PenjualanController::delete/$1'); 

$routes->get('resfull', 'MarketingController::index');
